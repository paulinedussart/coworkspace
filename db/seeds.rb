...
url = "https://images.unsplash.com/photo-1507537231947-f2ff14bc1554?ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&q=80"
smart_point = Space.new(name: "SmArt.Point", address: "Baizakov St 280, Almaty 050040, Kazakhstan", owner: aude)
...
club_coworking = Space.new(name: "Club Coworking", address: "Jamiyan Gun Str. 9, Sukhbaatar District, 1st Khoroo ICC Tower, 13th Floor, Ulaanbaatar 14240, Mongolie", owner: jack, opening_hours: {"Mon-Fri": "8AMP-8PM", "Sat": "9AM-6PM", "Sun": "10AM-1PM"})
...
ay7_coworking = Space.new(name: "7AY Coworking", address: "Lot 15, 16 - Zone industrielle Takadoum، Rabat, Maroc", owner: jack, opening_hours: {"Mon-Fri": "8AMP-8PM", "Sat": "9AM-6PM", "Sun": "10AM-1PM"})
...
cowork_central = Space.new(name: "Cowork Central – Cais do Sodré", address: "Praça Duque da Terceira 24, 1200-161 Lisboa, Portugal", owner: jack, opening_hours: {'Mon-Fri': '8AMP-8PM', 'Sat': '9AM-6PM', 'Sun': '10AM-1PM'})
...
sun_and_co = Space.new(name: "Sun and Co.", address: "Carrer Príncep d'Astúries, 40, 03730 Xàbia, Alacant, Espagne", owner: bob, opening_hours: {'Mon-Fri': '8AMP-8PM', 'Sat': '9AM-6PM', 'Sun': '10AM-1PM'})
...
e_commerce_park_of_sweden = Space.new(name: "E-Commerce Park of Sweden", address: "Vasatorpsvägen 1C, 254 57 Helsingborg, Suède", owner: bob, opening_hours: {'Mon-Fri': '8AMP-8PM', 'Sat': '9AM-6PM', 'Sun': '10AM-1PM'})
...
optimus_coworking_space = Space.new(name: "Optimus Coworking Space", address: "El Gomhouria St, Mit Khamis WA Kafr Al Mougi, Mansoura, Dakahlia Governorate, Égypte", owner: aude, opening_hours: {'Mon-Fri': '8AMP-8PM', 'Sat': '9AM-6PM', 'Sun': '10AM-1PM'})
...
hub_southern_cross_melbourne = Space.new(name: "Hub Southern Cross - Melbourne", address: "696 Bourke St, Melbourne VIC 3000, Australie", owner: aude, opening_hours: {'Mon-Fri': '8AMP-8PM', 'Sat': '9AM-6PM', 'Sun': '10AM-1PM'})
# hub_southern_cross_melbourne.remote_photo_url = url
hub_southern_cross_melbourne.save

url = "https://images.unsplash.com/photo-1526948128573-703ee1aeb6fa?ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&q=80"
fishburners = Space.new(name: "Fishburners", address: "level 2/11 York St, Sydney NSW 2000, Australie", owner: aude, opening_hours: {'Mon-Fri': '8AMP-8PM', 'Sat': '9AM-6PM', 'Sun': '10AM-1PM'})
...
spacecubed = Space.new(name: "Spacecubed", address: "45 St Georges Terrace, Perth WA 6000, Australie", owner: bob, opening_hours: {'Mon-Fri': '8AMP-8PM', 'Sat': '9AM-6PM', 'Sun': '10AM-1PM'})
...
the_emery = Space.new(name: "The Emery", address: "801 N Federal Hwy #212, Hallandale Beach, FL 33009, États-Unis", owner: bob, opening_hours: {'Mon-Fri': '8AMP-8PM', 'Sat': '9AM-6PM', 'Sun': '10AM-1PM'})
...
station_house = Space.new(name: "Station House", address: "260 1st Ave S, St. Petersburg, FL 33701, États-Unis", owner: bob, opening_hours: {'Mon-Fri': '8AMP-8PM', 'Sat': '9AM-6PM', 'Sun': '10AM-1PM'})
...
talent_hub = Space.new(name: "Talent HUB", address: "Saint-Claude, Guadeloupe", description: 'New establishment, private access to the sea. Free deckchairs at your disposal.', owner: bob, opening_hours: {'Mon-Fri': '8AMP-8PM', 'Sat': '9AM-6PM', 'Sun': '10AM-1PM'}, website: 'www.talenthub.fr/rdv')
...
up_and_space_martinique = Space.new(name: "Up and Space Martinique", address: "108 ZAC Les Coteaux, Sainte-Luce 97228, Martinique", description: 'New establishment, private access to the sea. Free deckchairs at your disposal and free coffee.', owner: bob, opening_hours: {'Mon-Fri': '8AMP-8PM', 'Sat': '9AM-6PM', 'Sun': '10AM-1PM'}, website: 'http://upandspace.info/concours-fabrique-aviva/?fbclid=IwAR2X1cD3hhugDgd8mO85Fo9l_5jWfo2eN_oopaH-YkpVLATDe-0jf9SlPXc')
# up_and_space_martinique.remote_photo_url = url
up_and_space_martinique.save

url = "https://images.unsplash.com/photo-1526786220381-1d21eedf92bf?ixlib=rb-1.2.1&auto=format&fit=crop&w=1000&q=80"
le_spot = Space.new(name: "Le Spot", address: "Rue Ferdinand Forest, Baie Mahault, Guadeloupe", description: 'New establishment, private access to the sea. Free deckchairs at your disposal.', phone: '0693847569', owner: bob, opening_hours: {'Mon-Fri': '8AMP-8PM', 'Sat': '9AM-6PM', 'Sun': '10AM-1PM'}, website: 'http://guadeloupe-coworking.com')
...
the_hub = Space.new(name: "The Hub", address: "34 Lady Musgrave Rd, Kingston, Jamaïque", description: 'New establishment, private access to the sea. Free deckchairs at your disposal.', phone: '0693347569', owner: bob, opening_hours: {'Mon-Fri': '8AMP-8PM', 'Sat': '9AM-6PM', 'Sun': '10AM-1PM'}, website: 'http://www.hubcoworking.net')
...
mtp = Space.new(name: "MTP", address: "4 Rue Auguste Comte, 34000 Montpellier, France", description: 'New establishment, private access to the sea. Free deckchairs at your disposal.', phone: '0693847519', owner: bob, opening_hours: {'Mon-Fri': '8AMP-8PM', 'Sat': '9AM-6PM', 'Sun': '10AM-1PM'})
...
rent24 = Space.new(name: "Rent24", address: "Potsdamer Straße 182/4.og, 10783 Berlin, Allemagne", owner: bob, opening_hours: {'Mon-Fri': '8AMP-8PM', 'Sat': '9AM-6PM', 'Sun': '10AM-1PM'})
...
polo = Space.new(name: "Polo", address: "Plac Konesera 10, 03-736 Warszawa, Pologne", owner: bob, opening_hours: {'Mon-Fri': '8AMP-8PM', 'Sat': '9AM-6PM', 'Sun': '10AM-1PM'})
# polo.remote_photo_url = url
polo.save

url = "https://images.unsplash.com/photo-1556745753-b2904692b3cd?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1000&q=80"
cowork_in_montpellier = Space.new(name: "Cowork'in Montpellier", address: "4 Rue Auguste Comte, 34000 Montpellier", description: 'New establishment, private access to the sea. Free deckchairs at your disposal.', phone: '0643847569', owner: bob, opening_hours: {'Mon-Fri': '8AMP-8PM', 'Sat': '9AM-6PM', 'Sun': '10AM-1PM'})
...
the_island = Space.new(name: "The Island", address: "19 Avenue de Toulouse, 34070 Montpellier", description: 'New establishment, private access to the sea. Free deckchairs at your disposal.', owner: aude, opening_hours: {'Mon-Fri': '8AMP-8PM', 'Sat': '9AM-6PM', 'Sun': '10AM-1PM'})
...
guaja_café_coworking = Space.new(name: "GUAJA Café & Coworking", address: "Av. Afonso Pena, 2881 - Funcionários, Belo Horizonte - MG, 30130-011, Brésil", owner: jack, opening_hours: {'Mon-Fri': '8AMP-8PM', 'Sat': '9AM-6PM', 'Sun': '10AM-1PM'})
...
rather_coworking = Space.new(name: "Rather Coworking", address: "R. José Maia Gomes, 258 - Jatiúca, Maceió - AL, 57036-240, Brésil", owner: jack, opening_hours: {'Mon-Fri': '8AMP-8PM', 'Sat': '9AM-6PM', 'Sun': '10AM-1PM'})
...
the_lab_miami = Space.new(name: "The Lab Miami", address: "400 NW 26th St, Miami, FL 33127, États-Unis", owner: jack, opening_hours: {'Mon-Fri': '8AMP-8PM', 'Sat': '9AM-6PM', 'Sun': '10AM-1PM'})
...
we_work = Space.new(name: "We Work", address: "US Custom House, 220 NW 8th Ave, Portland, OR 97209, États-Unis", owner: jack, opening_hours: {'Mon-Fri': '8AMP-8PM', 'Sat': '9AM-6PM', 'Sun': '10AM-1PM'})
...
chillhy = Space.new(name: "Chill'Hi", address: "Aviador David Fuentes, Pudahuel, Región Metropolitana, Chili", owner: bob, opening_hours: {'Mon-Fri': '8AMP-8PM', 'Sat': '9AM-6PM', 'Sun': '10AM-1PM'})
...
co_white_house_work = Space.new(name: "Co White House Work", address: "1600 Pennsylvania Ave NW, Washington, DC 20500, États-Unis", owner: bob, opening_hours: {'Mon-Fri': '8AMP-8PM', 'Sat': '9AM-6PM', 'Sun': '10AM-1PM'})
...
coworking_legian = Space.new(name: "Coworking Legian", address: "999 S Logan St Suite 202, Denver, CO 80209, États-Unis", owner: jack, opening_hours: {'Mon-Fri': '8AMP-8PM', 'Sat': '9AM-6PM', 'Sun': '10AM-1PM'})
...
finns_bali = Space.new(name: "Finns Bali", address: "No.90X Jalan Monkey Forest, Ubud, Bali, Indonesia", owner: jack, opening_hours: {'Mon-Fri': '8AMP-8PM', 'Sat': '9AM-6PM', 'Sun': '10AM-1PM'})
...
africa_work = Space.new(name: "Africa Work", address: "Suite 303 The Point Mall, 76 Regent Rd, Sea Point, Cape Town, 8005, Afrique du Sud", owner: jack, opening_hours: {'Mon-Fri': '8AMP-8PM', 'Sat': '9AM-6PM', 'Sun': '10AM-1PM'})
...
africowork = Space.new(name: "Africowork", address: "1, King Shaka Ave, Point, Durban, 4001, Afrique du Sud", owner: jack, opening_hours: {'Mon-Fri': '8AMP-8PM', 'Sat': '9AM-6PM', 'Sun': '10AM-1PM'})
...
africa_south = Space.new(name: "Africa South", address: "Point Close, Eastford, Knysna, 6571, Afrique du Sud", owner: jack, opening_hours: {'Mon-Fri': '8AMP-8PM', 'Sat': '9AM-6PM', 'Sun': '10AM-1PM'})
...
etincelle_cowoking = Space.new(name: "Etincelle Cowoking", address: " 2 Rue d'Austerlitz, 31000 Toulouse", owner: bob, opening_hours: {'Mon-Fri': '8AMP-8PM', 'Sat': '9AM-6PM', 'Sun': '10AM-1PM'})
...
coworkimmo = Space.new(name: "Coworkimmo", address: " 23 Rue Edmond Michelet, 33000 Bordeaux", owner: bob, opening_hours: {'Mon-Fri': '8AMP-8PM', 'Sat': '9AM-6PM', 'Sun': '10AM-1PM'})
...
we_work_in_russia = Space.new(name: "We Work In Russia", address: "Sergeya Makeeva Street, 15, Moskva, Russie, 123100", owner: bob, opening_hours: {'Mon-Fri': '8AMP-8PM', 'Sat': '9AM-6PM', 'Sun': '10AM-1PM'})
...
coldn_work = Space.new(name: "Cold'n work", address: "SKhanty-Mansiïsk, Ханты-Мансийский Автономный округ - Югра Аутономус Область, Russie", owner: bob, opening_hours: {'Mon-Fri': '8AMP-8PM', 'Sat': '9AM-6PM', 'Sun': '10AM-1PM'})
...
o_greck = Space.new(name: "O greck", address: "Αλμυρός 374 00, Grèce", owner: jack, opening_hours: {'Mon-Fri': '8AMP-8PM', 'Sat': '9AM-6PM', 'Sun': '10AM-1PM'})
...
greck_work = Space.new(name: "Greck'Work", address: "Heraklion 716 01, Grèce", owner: aude, opening_hours: {'Mon-Fri': '8AMP-8PM', 'Sat': '9AM-6PM', 'Sun': '10AM-1PM'})
